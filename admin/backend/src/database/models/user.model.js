import { KYC_STATUS, KYC_LEVELS, SIGN_IN_METHOD, USER_GENDER } from '@src/utils/constants/public.constants.utils'
...
export default class User extends ModelBase {
  ...
  static associate (models) {
    ...
    User.belongsTo(models.adminUser, { foreignKey: 'kycVerifiedBy', as: 'kycVerifier' })
