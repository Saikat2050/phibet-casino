...
import { FIELD_TYPES, getFieldType, operators } from './constants';
import { dateTypeForValidation, maxFieldNum } from '../Segmentation/constants';
...
const fieldValidationSchema = Yup.object({
	...
	value1: Yup.mixed()
		...
		.test('value1-required', function (value) {
			...
			const message = isValue2Required ? 'Value1 is required' : 'Value is required';
