...
var slotConfig3x5 = {
    ...
    fonts: [
        {
            fontName: 'gameFont',
            filePNG:  'fonts/coiny_p30_38_2.png',
            fileXML:  'fonts/coiny_p30_38_2.xml'
        },
        {
            fontName: 'gameFont_1',
            filePNG:  'fonts/coiny_38_1.png',
            fileXML:  'fonts/coiny_38_1.xml'
        },
        {
            fontName: 'gameFont_2',
            filePNG:  'fonts/coiny_p30_38_1.png',
            fileXML:  'fonts/coiny_p30_38_1.xml'
        },
    ],
    ...
    [
        {
            fileName: 'Bells.png',                   // filename or null
            name: 'Bells',                           // sprite name
            fileNameBlurred: 'BellsBlurred.png',     // blurry symbol file name, folder png/SymbolsBlurred
            animation: 'BellsSheet.png',             // animation sheet file name, folder png/SymbolsSheet
        ...
        },
        {
            ...
            name: 'Cookies',                   
            fileNameBlurred: 'CookiesBlurred.png', 
            animation: 'CookiesSheet.png',
            useWildSubstitute: true
        },
        {
            fileName: '10.png',          
        ...
        },
        {
            fileName: 'Wreath.png',          
            name: 'Wreath',                   
            fileNameBlurred: 'WreathBlurred.png', 
            animation: 'WreathSheet.png',
            useWildSubstitute: true
        },
        {
            fileName: 'Sock.png',          
            name: 'Sock',                   
            fileNameBlurred: 'SockBlurred.png', 
            animation: 'SockSheet.png',
            useWildSubstitute: true
        },
        {
            fileName: 'J.png',          
    ...
    reels:[
        {//0
            symbolImages: ['Cookies', 'Sock', 'J', 'Sock', 'Q', 'Bells', 'Wreath', 'K', 'A', 'Bells'],                         // Wreath
            offsetX: -520,
            offsetY: -66,
        ...
        {//1
            symbolImages: ['Sock', 'Bells', 'Wild', 'Cookies','Q', 'Sock', 'J', 'Bells', 'K','A', 'Wreath', 'Bells'],               // 12 J 'Wild', -> J bells
            offsetX: -260,
            offsetY: -66,
            windowImage: 'reel',        // not used
            windowsCount: 3,    
        ...
        { // 2
            symbolImages: ['Sock', 'Wild', 'K', 'Cookies', 'Q', 'Bells', 'Sock', 'J', 'Wild', 'Scatter', 'A', 'Wild', 'Wreath'],   // 13
            offsetX: 0,
            offsetY: -66,
            windowImage: 'reel',        // not used
            windowsCount: 3,
        ...
        { // 3
            symbolImages: ['Cookies', 'Sock', 'Wild', 'J', 'Q', 'Sock', 'Wild', 'K', 'A', 'Wild', 'Scatter', 'Bells', 'Scatter', 'Wreath'],   // 14
            offsetX: 260,
            offsetY: -66,
            windowImage: 'reel',        // not used
            windowsCount: 3,
        ...
        { // 4
            symbolImages: ['Bells', 'Wild', 'Sock', 'Cookies', 'Sock', 'J', 'Wild', 'Q', 'A', 'Wild', 'Scatter', 'K', 'Scatter' , 'Wreath'],   // 14
            offsetX: 520,
            offsetY: -66,
            windowImage: 'reel',        // not used
            windowsCount: 3,
    ...
    payLines:[
        {
            line: ['Bells', 'Bells', 'Bells', 'Bells', 'Bells'],
            pay: 3,
            freeSpins: 0
        },
        {
            line: ['Bells', 'Bells', 'Bells', 'Bells', 'any'],
            pay: 2,
            freeSpins: 0
        },
        {
            line: ['Bells', 'Bells', 'Bells', 'any', 'any'],
            pay: 1,
            freeSpins: 0
        },
        {
        ...
        {
            line: ['Cookies', 'Cookies', 'Cookies', 'Cookies', 'Cookies'],
            pay: 6,
            freeSpins: 0
        },
        {
            line: ['Cookies', 'Cookies', 'Cookies', 'Cookies', 'any'],
            pay: 3,
            freeSpins: 0
        },
        {
            line: ['Cookies', 'Cookies', 'Cookies', 'any', 'any'],
            pay: 2,
            freeSpins: 0
        },
        {
            line: ['Sock', 'Sock', 'Sock', 'Sock', 'Sock'],
            pay: 7,
            freeSpins: 0
        },
        {
            line: ['Sock', 'Sock', 'Sock', 'Sock', 'any'],
            pay: 3,
            freeSpins: 0
        },
        {
            line: ['Sock', 'Sock', 'Sock', 'any', 'any'],
            pay: 2,
            freeSpins: 0
        },
        {
            line: ['Wreath', 'Wreath', 'Wreath', 'Wreath', 'Wreath'],
            pay: 8,
            freeSpins: 0
        },
        {
            line: ['Wreath', 'Wreath', 'Wreath', 'Wreath', 'any'],
            pay: 3,
            freeSpins: 0
        },
        {
            line: ['Wreath', 'Wreath', 'Wreath', 'any', 'any'],
            pay: 2,
            freeSpins: 0
        },
        {
    ...
    createSlotGraphic: function(scene){
        ...
        */
         ...
         scene.slot =  scene.addSpriteLocPos('slot', 0, -66); 
         scene.slot.depth = -1;
         scene.slot =  scene.addSpriteLocPos('slotmasktop', 0, -410); 
         scene.slot =  scene.addSpriteLocPos('slotmaskbottom', 0, 275); 

         scene.totalbetPanel = scene.addSpriteLocPos('panel_totalbet', -370, 205 + 220); 
         scene.linesPanel = scene.addSpriteLocPos('panel_lines', -650, 196 + 220); 
         scene.balancePanel = scene.addSpriteLocPos('panel_balance', 370, 196 + 220); 
         scene.winPanel = scene.addSpriteLocPos('panel_win', 650, 202 + 220); 
    },
    ...
    createControls: function(scene, slotControls) {
        ...
        slotControls.totalBetMinusButton.create(-365-95, 208 + 220, 0.5, 0.5);
        ...
        slotControls.totalBetPlusButton.create(-365 + 95, 208 + 220, 0.5, 0.5);
        ...
        slotControls.slotMaxBetButton.create(-130, 225 + 200, 0.5, 0.5);
        ...
        slotControls.slotAutoSpinButton.create(130, 225 + 200, 0.5, 0.5);
        ...
        slotControls.settingsButton.create(860, -260, 0.5, 0.5);
       ...
       slotControls.rulesButton.create(860, -160, 0.5, 0.5);
       ...
       slotControls.slotInfoButton.create(860, -60, 0.5, 0.5);
       ...
       slotControls.slotInfoButton.button.setVisible(false); 
        ...
        slotControls.linesText = scene.add.bitmapText(scene.centerX - 650, scene.centerY + 160 + 220, 'gameFont_2', 'Lines', 24, 1).setOrigin(0.5);
        slotControls.linesCountText = scene.add.bitmapText(scene.centerX - 652, scene.centerY + 210 + 220, 'gameFont_1', slotControls.selectedLinesCount, 36, 1).setOrigin(0.5);
        ...
        slotControls.lineBetAmountText = scene.add.bitmapText(scene.centerX - 420, scene.centerY + 210 + 220, 'gameFont_1', slotControls.lineBet, 36, 1).setOrigin(0.5);
        ...
        slotControls.totalBetText = scene.add.bitmapText(scene.centerX - 370, scene.centerY + 160 + 220, 'gameFont_2', 'Total  Bet', 24, 1).setOrigin(0.5);
        // slotControls.totalBetText.tint = this.slotTextColor;
  
        slotControls.totalBetSumText = scene.add.bitmapText(scene.centerX - 370, scene.centerY + 210 + 220, 'gameFont_1', slotControls.getTotalBet(), 36, 1).setOrigin(0.5);
        // slotControls.totalBetSumText.tint = this.slotTextColor;
 
        slotControls.creditText = scene.add.bitmapText(scene.centerX + 370, scene.centerY + 160 + 220, 'gameFont_2', 'Balance', 24, 1).setOrigin(0.5);
        // slotControls.creditText.tint = this.slotTextColor;

        slotControls.creditSumText = scene.add.bitmapText(scene.centerX + 370, scene.centerY + 210 + 220, 'gameFont_1', '$' + scene.slotPlayer.coins, 36, 1).setOrigin(0.5);
        // slotControls.creditSumText.tint = this.slotTextColor;
         
        slotControls.winText = scene.add.bitmapText(scene.centerX + 650, scene.centerY + 160 + 220, 'gameFont_2', 'Your  Win', 24, 1).setOrigin(0.5);

        slotControls.winAmountText = scene.add.bitmapText(scene.centerX + 650, scene.centerY + 210 + 220, 'gameFont_1', '0', 36, 1).setOrigin(0.5);
        // slotControls.winAmountText.tint = this.slotTextColor;
        // slotControls.winAmountText.setVisible(false);
 
        slotControls.autoSpinText = scene.add.bitmapText(scene.centerX + 135, scene.centerY + 230 + 200, 'gameFont_1', 'AUTO\nSPIN', 28, 1).setOrigin(0.5);
        slotControls.maxBetText = scene.add.bitmapText(scene.centerX - 135, scene.centerY + 230 + 200, 'gameFont_1', 'MAX\nBET', 28, 1).setOrigin(0.5);
        slotControls.spinText = scene.add.bitmapText(scene.centerX - 0, scene.centerY + 225 + 200, 'gameFont_1', 'SPIN', 48, 1).setOrigin(0.5);
    ...
    createInfoPUHandler: function(popup)
    {
        function createSymbolPlate5x (popup, parentContainer, symbSpriteName, posX, posY, price3x,price4x, price5x)
        {
            ...
            let textXPos = -20;
            let text3x = popup.scene.add.bitmapText(textXPos, 48, 'gameFont', '3x - ' + price3x, 36, 1).setOrigin(0, 0.5);
            symbContainer.add(text3x);
    
            let text4x = popup.scene.add.bitmapText(textXPos, 0, 'gameFont', '4x - ' + price4x, 36, 1).setOrigin(0, 0.5);
            symbContainer.add(text4x);

            let text5x = popup.scene.add.bitmapText(textXPos, -48, 'gameFont', '5x - ' + price5x, 36, 1).setOrigin(0, 0.5);
        ...
        function createSpecSymbolPlate(popup, parentContainer, symbSpriteName, posX, posY, info)
        {
            ...
            let textInfo = popup.scene.add.bitmapText(160, 0, 'gameFont', info, 28, 0).setOrigin(0, 0.5);
        ...
        let title = popup.scene.add.sprite(0, -375 + offsetY, 'help_title').setOrigin(0.5);
        popup.add(title);

        popup.addButton('exitButton','exit_button', 'exit_button_hover', false, 650, -300 + offsetY);
        ...
        // minor row 1
        createSymbolPlate5x(popup, minorContainer, 'Bells',  col1X , row1Y, 1, 2, 3);
        createSymbolPlate5x(popup, minorContainer, 'Candles', col2X , row1Y, 1, 3, 5);
        createSymbolPlate5x(popup, minorContainer, 'Cookies', col3X , row1Y, 2, 3, 6);

        // minor row 2
        createSymbolPlate5x(popup, minorContainer, 'Sock', col1X + 0.5 * colDist, row2Y, 2, 3, 7);
        createSymbolPlate5x(popup, minorContainer, 'Wreath', col2X + 0.5 * colDist, row2Y, 2, 3, 8);
        ...
        // special row 1
        createSpecSymbolPlate(popup, specialContainer, 'Wild', -300, -40, 'Wild can be used with any symbols \non the reels to create winning \ncombinations (exclude first reel).');
        createSpecSymbolPlate(popup, specialContainer, 'Scatter', -300 , 200, 'Any 5 scatter on the screen \ngive the player  5 free spins.');
        ...
        let aboutTitle = popup.scene.add.bitmapText(-570, -100, 'gameFont', 'ABOUT  THE  GAME', 33, 0).setOrigin(0,0.5); // text
        rulesContainer.add(aboutTitle);
        let aboutText = popup.scene.add.bitmapText(-570, -60, 'gameFont',
        'Christmas Eve is a pack of Slot Games with 3-5 reels and 243 paylines oriented \nfrom left to right. The games have 8 regular symbols that win if three or more \nare lined up in sequence on a payline, beginning from the leftmost position. The \n6 high pay symbols and the 2 low pay symbols.', 28, 0).setOrigin(0, 0); // text
        rulesContainer.add(aboutText);


        let howTitle = popup.scene.add.bitmapText(-570, 140, 'gameFont', 'HOW  TO  PLAY', 33, 0).setOrigin(0,0.5); // text
        rulesContainer.add(howTitle);
        let howText = popup.scene.add.bitmapText(-570, 180, 'gameFont',
        '- Place your bet \n- Press the Spin button to start game \n- You can also use Max Bet button to auto bet \n- Press the AutoSpin button to turn Auto Spin game mode', 28, 0).setOrigin(0, 0); // text
    ...
    {       
        ...
        // add title
        let title = popup.scene.add.sprite(0, -320 + yOffset, 'about_title').setOrigin(0.5);
        popup.add(title);
        ...
        // add message
        popup.messageText = popup.scene.add.bitmapText(0, 125 + yOffset, 'gameFont', 'NEED HELP?', 28, 1).setOrigin(0.5);
        ...
        popup.addButton('exitButton','exit_button', 'exit_button_hover', false, 230, -240  + yOffset);
        ...
        popup.supText = popup.scene.add.bitmapText(0, 205 + yOffset, 'gameFont_1', 'SUPPORT', 36, 1).setOrigin(0.5);
    ...
    {    
        ...
        // add title
        let title = popup.scene.add.sprite(0, -295 + yOffset, 'settings_title').setOrigin(0.5);
        popup.add(title);

        // sound and music text
        popup.soundText = popup.scene.add.bitmapText(-100, -125 + yOffset, 'gameFont', 'SOUNDS', 28, 1).setOrigin(0.5);
        popup.soundText.tint = 0xFFFFFF;
        popup.add(popup.soundText);

        popup.musicText = popup.scene.add.bitmapText(100, -125 + yOffset, 'gameFont', 'MUSIC', 28, 1).setOrigin(0.5);
        popup.musicText.tint = 0xFFFFFF;
        popup.add(popup.musicText);

        // sound and music buttons
        popup.addButton('soundButton','button_on', 'button_off', true, -100, -47 + yOffset);
        popup.addButton('musicButton','button_on', 'button_off', true, 99, -47 + yOffset);
        ...
        popup.addButton('termsButton','extralong_button', 'extralong_button_hover', false, 0, 182 + yOffset);
        ...
        popup.privacyText = popup.scene.add.bitmapText(0, 87 + yOffset, 'gameFont_1', 'PRIVACY POLICY', 36, 1).setOrigin(0.5);
        popup.privacyText.tint = 0xFFFFFF;
        popup.add(popup.privacyText);

        popup.termsText = popup.scene.add.bitmapText(0, 187 + yOffset, 'gameFont_1', 'TERMS OF USE', 36, 1).setOrigin(0.5);
        popup.privacyText.tint = 0xFFFFFF;
    ...
    createFreeGamesPUHandler: function(popup)
    {
        ...
        popup.add(backGround);
        // backGround.setAlpha(0.5);
        let panel = popup.scene.add.sprite(0, 0, 'freespin_panel').setOrigin(0.5);
        popup.add(panel);
        ...
        // add message
        popup.messageText = popup.scene.add.bitmapText(0, -40, 'gameFont_1', popup.scene.winSpins, 48, 1).setOrigin(0.5);
        popup.messageText.tint = 0xFFFFFF;
        popup.add(popup.messageText);

        // add buttons
        popup.addButton('okButton','long_button', 'long_button_hover', false, 0, 180);
        ...
        // add button text
        popup.okText = popup.scene.add.bitmapText(0, 185, 'gameFont_1', 'START', 36, 1).setOrigin(0.5);
    ...
    createBigWinPUHandler: function(popup)
    {
        ...
        popup.add(backGround);
        // backGround.setAlpha(0.5);
        let panel = popup.scene.add.sprite(0, 0, 'bigwin_panel').setOrigin(0.5);
        popup.add(panel);

        // add message
        popup.messageText = popup.scene.add.bitmapText(0, 20, 'gameFont_1', popup.scene.winCoins, 48, 1).setOrigin(0.5);
        popup.messageText.tint = 0xFFFFFF;
        popup.add(popup.messageText);
    },
    ...
    createHugeWinPUHandler: function(popup)
    {
        ...
        popup.add(backGround);
        // backGround.setAlpha(0.5);
        let panel = popup.scene.add.sprite(0, 0, 'hugewin_panel').setOrigin(0.5);
        popup.add(panel);

        // add message
        popup.messageText = popup.scene.add.bitmapText(0, 70, 'gameFont_1', popup.scene.winCoins, 48, 1).setOrigin(0.5);
        popup.messageText.tint = 0xFFFFFF;
        popup.add(popup.messageText);
    },
    ...
    createMegaWinPUHandler: function(popup)
    {
        ...
        popup.add(backGround);
        // backGround.setAlpha(0.5);
        let panel = popup.scene.add.sprite(0, 0, 'megawin_panel').setOrigin(0.5);
        popup.add(panel);

        // add message
        popup.messageText = popup.scene.add.bitmapText(0, 40, 'gameFont_1', popup.scene.winCoins, 48, 1).setOrigin(0.5);
        popup.messageText.tint = 0xFFFFFF;
        popup.add(popup.messageText);
    },
}
