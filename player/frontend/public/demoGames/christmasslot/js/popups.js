...
function createGameMessagePUHandlerYNC(popup)
{
    ...
    // add caption
    popup.captionText = popup.scene.add.bitmapText(0, -60, 'gameFont', 'Caption', 28, 1).setOrigin(0.5);
    popup.captionText.tint = 0xFFFFFF;
    popup.add(popup.captionText);

    // add message
    popup.messageText = popup.scene.add.bitmapText(0, -0, 'gameFont', 'Message', 28, 1).setOrigin(0.5);
    popup.messageText.tint = 0xFFFFFF;
    popup.add(popup.messageText);

    // add buttons
    popup.addButton('okButton','middle_button', 'middle_button_hover', false, -100, 130);
    popup.addButton('noButton','middle_button', 'middle_button_hover', false, 100, 130);
    popup.addButton('exitButton','exit_button', 'exit_button_hover', false, 230, -165);
    ...
    // add button text
    popup.okText = popup.scene.add.bitmapText(-100, 135, 'gameFont_1', 'OK', 36, 1).setOrigin(0.5);
    popup.okText.tint = 0xFFFFFF;
    popup.add(popup.okText);

    popup.noText = popup.scene.add.bitmapText(100, 135, 'gameFont_1', 'NO', 36, 1).setOrigin(0.5);
